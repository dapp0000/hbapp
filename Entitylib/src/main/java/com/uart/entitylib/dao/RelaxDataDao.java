...
public class RelaxDataDao extends AbstractDao<RelaxData, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Relax = new Property(4, Integer.class, "relax", false, "RELAX");
    ...
    public RelaxData readEntity(Cursor cursor, int offset) {
        RelaxData entity = new RelaxData( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getInt(offset + 4), // relax
    ...
    public void readEntity(Cursor cursor, RelaxData entity, int offset) {
        ...
        entity.setRelax(cursor.isNull(offset + 4) ? null : cursor.getInt(offset + 4));
